...
public class PersonalAccidentAdapter extends RecyclerView.Adapter<PersonalAccidentAdapter.PAViewHolder> {
    ...
    public PersonalAccidentAdapter(ArrayList<PersonalAccidentData> mMotorList, Context context) {
