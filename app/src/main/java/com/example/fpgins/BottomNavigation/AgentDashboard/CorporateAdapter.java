...
public class CorporateAdapter extends RecyclerView.Adapter<CorporateAdapter.CorporateViewHolder> {
    ...
    public CorporateAdapter(ArrayList<CorporateData> mCorpoList, Context context) {
    ...
    @Override
    public CorporateViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.motor_item_list,
                parent, false);
        CorporateViewHolder evh = new CorporateViewHolder(v);
        return evh;
    }

    @Override
    public void onBindViewHolder(CorporateViewHolder holder, int position) {
