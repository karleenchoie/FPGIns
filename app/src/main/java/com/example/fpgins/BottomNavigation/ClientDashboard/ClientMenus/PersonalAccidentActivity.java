...
public class PersonalAccidentActivity extends AppCompatActivity {
    ...
    private PersonalAccidentAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFilterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
//                showFilter();
                LayoutInflater li = LayoutInflater.from(PersonalAccidentActivity.this);
                View view = li.inflate(R.layout.fragment_filter, null);

                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(PersonalAccidentActivity.this);
                ...
                groupValue.setOnCheckedChangeListener(new ChipGroup.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(ChipGroup chipGroup, int i) {
                        ...
                        if (chip != null){
                            Toast.makeText(PersonalAccidentActivity.this, chip.getText().toString(),Toast.LENGTH_LONG).show();
                ...
                for(int i = 0; i < groupMake.getChildCount(); i++){
                    ...
                    chip.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                        ...
                        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                            ...
                            if(!list.isEmpty()){
                                Toast.makeText(PersonalAccidentActivity.this, list.toString(),Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
...
//        entryChipGroup.addView(entryChip2);
    ...
    private void buildRecyclerView() {
        ...
        mAdapter = new PersonalAccidentAdapter(mPAList, getApplicationContext());
