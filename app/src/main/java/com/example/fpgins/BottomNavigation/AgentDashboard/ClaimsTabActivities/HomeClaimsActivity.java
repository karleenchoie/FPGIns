...
public class HomeClaimsActivity extends AppCompatActivity {
    ...
    private HomeClaimsAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_claims);
        ...
        mFilterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
//                showFilter();
                LayoutInflater li = LayoutInflater.from(HomeClaimsActivity.this);
                View view = li.inflate(R.layout.fragment_filter, null);

                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(HomeClaimsActivity.this);
                ...
                groupValue.setOnCheckedChangeListener(new ChipGroup.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(ChipGroup chipGroup, int i) {
                        ...
                        if (chip != null){
                            Toast.makeText(HomeClaimsActivity.this, chip.getText().toString(),Toast.LENGTH_LONG).show();
                ...
                for(int i = 0; i < groupMake.getChildCount(); i++){
                    ...
                    chip.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                        ...
                        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                            ...
                            if(!list.isEmpty()){
                                Toast.makeText(HomeClaimsActivity.this, list.toString(),Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
...
//                                String output = list.toString().replaceAll("(^\\[|\\]$)", "");
    ...
    private void buildRecyclerView() {
        ...
        mAdapter = new HomeClaimsAdapter(mHomeList, getApplicationContext());
