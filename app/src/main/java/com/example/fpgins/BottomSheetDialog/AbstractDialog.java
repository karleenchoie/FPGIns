...
//    protected LottieAnimationView mAnimationView;
    ...
    protected View createView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
        ...
        View dialogView = inflater.inflate(R.layout.layout_alert_dialog, container, false);
...
//        mAnimationView = dialogView.findViewById(R.id.animation_view);
        ...
        if (mPositiveButton != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && mPositiveButton.getIcon() != NO_ICON) {
                mPositiveButtonView.setCompoundDrawablesWithIntrinsicBounds(mActivity.getDrawable(mPositiveButton.getIcon()), null, null, null);
            }
        ...
        if (mNegativeButton != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && mNegativeButton.getIcon() != NO_ICON) {
                mNegativeButtonView.setCompoundDrawablesWithIntrinsicBounds(mActivity.getDrawable(mNegativeButton.getIcon()), null, null, null);
            }
...
//        }
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mPositiveButtonView.setBackgroundTintList(mPositiveButtonTint);
            }
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mNegativeButtonView.setBackgroundTintList(mNegativeButtonTint);
            }
