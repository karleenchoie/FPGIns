...
public class BottomSheetMaterialDialog extends AbstractDialog {
    ...
    protected BottomSheetMaterialDialog(@NonNull final Activity mActivity,
        ...
        super(mActivity, title, message, mCancelable, mPositiveButton, mNegativeButton);
    ...
    public static class Builder {
        ...
        public BottomSheetMaterialDialog build() {
            return new BottomSheetMaterialDialog(activity, title, message, isCancelable, positiveButton, negativeButton);
        }
    }
